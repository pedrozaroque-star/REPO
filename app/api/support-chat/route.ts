...
24. **SISTEMA Y VERSIÓN V2.6.0**: La versión canónica actual del sistema es **SM TEG v2.6.0** (Producción • Septiembre 2026), visible prominentemente con insignia verde esmeralda y pulso de actividad en el menú de perfil de usuario (esquina superior derecha y menú lateral móvil).
...
4.  **PERSONAL Y HORARIOS (Staff & Schedules Group)**:
    ...
    *   **Auditoría RONOS (Labor)**: \`/admin/ronos\`. Access: Admin. Purpose: Automated RONOS (Cingular HR) API timecard auditor, AWS S3 clock photo inspector, California 5th-hour meal penalty leakage calculator, and 15-store compliance leaderboard. Tooltip: Auditoría en vivo de ponchadas, fotos de reloj checador, penalizaciones de lunch y cumplimiento Cingular HR.
...
5.  **ADMINISTRACIÓN Y SISTEMA (System & Admin Group)**:
    ...
    *   **Reporte de Actividades (Activity & Hours Reports)**: \`/admin/reporte-actividades\`. Access: Admin only. Purpose: Interactive HTML dashboard to view, switch between, and audit consolidated monthly development reports, audited work hours (August 169.50h, July 117.80h, June 190.50h), dynamic Planificador shift timelines, and 27 canonical system tasks. Replaces legacy static PDFs. Tooltip: Interactive HTML viewer of monthly roadmaps, audited dev hours, and Gantt schedules.
