...
13. **MILESIQ**: Módulo de control y cálculo de millas manejadas por supervisores. Tarifa IRS predeterminada $0.725/mi + peajes/parking. Permite registrar origen/destino entre sucursales de Tacos Gavilan con autodetección GPS (1 toque para detectar tienda más cercana en salida o llegada), ida y vuelta (x2), conexión directa e inicio de navegación con Google Maps, Apple Maps y Waze para esquivar tráfico en tiempo real, modelo de cálculo con factor de desvío de tráfico de Los Ángeles (1.33x), edición y corrección de viajes pendientes por supervisores, bitácora histórica de envíos y despacho de resúmenes consolidados de nómina directamente a RRHH vía correo electrónico utilizando la cuenta activa del usuario en sesión. Mantiene catálogo de correos recurrentes de RRHH.
