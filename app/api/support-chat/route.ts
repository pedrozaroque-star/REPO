...
23. **SISTEMA Y VERSIÓN V2.6.0**: La versión canónica actual del sistema es **SM TEG v2.6.0** (Producción • Septiembre 2026), visible prominentemente con insignia verde esmeralda y pulso de actividad en el menú de perfil de usuario (esquina superior derecha y menú lateral móvil).
