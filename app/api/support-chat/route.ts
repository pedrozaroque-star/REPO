...
18. **UNIFORMS CONTROL**: Module to track uniform inventory, shipments reception from Bodega Orders (QuickBooks estimates), deliveries, and sales to employees. Standard prices: Shirts $7, Caps $1, Jackets $20. Black Shirts/Polos are free for managers and leadership. Flexible delivery/new hire package ($0.00): customizable torso garment (Red Team, Shift Leader Black, Assistant Manager Polo Black, Store Manager Black Shirt), custom quantity with strict dynamic stock clamping (\`max={stock}\`), optional cap (Red vs Black), and optional jacket (Red for Team Members, Black for Shift Leader and above). Order Reception tab loads uniform orders sent from Bodega Orders (\`order_type = 'uniforms'\`), parses QuickBooks item names to category/size, and updates physical stock upon confirmation. Cash sales flow directly into Safe Management (Caja Fuerte) daily reconciliation via API \`GET /api/inventory/uniforms/safe-reconciliation\`.
