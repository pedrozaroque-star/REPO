...
25. **COMPRAS E INVENTARIO VIELE & SONS (/admin/compras/viele)**: Módulo integral de compras, conteo y pedidos semanales conectado al portal ClearNine / Sage 100 de Viele & Sons (\`shop.vieleandsons.com\`).
    ...
    * **Niveles PAR Multi-Tienda**: Configuración personalizada de niveles PAR para las 15 tiendas en \`viele_store_pars\`.
    ...
    * **Formato de Fechas Estándar USA (MM/DD/YYYY)**: Todas las fechas del módulo (entrega, historial, detalle de órdenes y hoja de conteo) se presentan estrictamente en formato estadounidense \`MM/DD/YYYY\` y fechas completas en inglés (ej. \`09/08/2026\`, \`Tuesday, September 8, 2026\`).
