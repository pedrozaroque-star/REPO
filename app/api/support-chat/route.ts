...
25. **COMPRAS E INVENTARIO VIELE & SONS (/admin/compras/viele)**: Módulo integral de compras, conteo y pedidos semanales conectado al portal ClearNine / Sage 100 de Viele & Sons (\`shop.vieleandsons.com\`).
    ...
    * **Historial y Auditoría (/admin/compras/viele/historial)**: Bitácora completa de órdenes emitidas por tienda con desglose de artículos, cajas, precios unitarios e importes totales, filtro por tipo de factura (Insumos, Sodas, Químicos) y enlaces a facturas gemelas.
