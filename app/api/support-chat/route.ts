...
22. **AUDITORÍA LABORAL RONOS Y PROYECCIÓN CINGULAR HR**: Consulta asistencia por tienda y período, compara ubicaciones y vincula empleados. Facturación y Nómina calcula proyecciones. La API exige administrador y períodos completos; una cadena incompleta devuelve error con tiendas faltantes. Los recibos de Simplify HR se paginan y filtran por tienda, fechas inicial/final y estado aprobado/pagado. Las facturas locales verificadas se comparan por tienda y período y muestran cálculo − factura; sus IDs enlazan con Simplify, pero no con RONOS. Solo PIN único permite comparar bruto; un nombre coincidente es candidato. paystub_match confirma exclusivamente bruto en centavos; estimated carece de evidencia suficiente y variance tiene diferencia de bruto. Exponer advertencias y recibos sin vincular. Ningún resultado certifica cargos PEO, neto, reembolsos ni factura sin documento y vínculo de identidad. Los suplementos históricos solo aplican al período documentado. Las tarifas heredadas no tienen vigencia histórica certificada. La consulta no sincroniza semanas faltantes: requiere sincronización explícita.
**Regla vigente de veracidad RONOS**: La asistencia de RONOS es una proyección y los paystubs/invoices cerrados de Simplify HR/Cingular son la fuente contable final. El asistente debe llamar un resultado “conciliado” únicamente cuando compare el mismo período y lote oficial; de otra forma debe indicar “estimado” y enumerar los datos faltantes. No debe asumir que una alerta de comida representa una hora pagada ni resolver identidades, tarifas o transferencias por coincidencia ambigua de nombres.
