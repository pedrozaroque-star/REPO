...
- **Regla Fiscal Exención de Alimentos & Validación Sage 100**:
  - Paridad Fiscal 0% Tax: Las órdenes de insumos y abarrotes alimenticios se procesan con \`taxAmount = 0\` y \`totalAmount = subtotalAmount\`, erradicando cargos ficticios de sales tax.
