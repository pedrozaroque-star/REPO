...
4.  **PERSONAL Y HORARIOS (Staff & Schedules Group)**:
    ...
    *   **Auditoría RONOS (Labor)**: \`/admin/ronos\`. Access: Admin, Manager, Supervisor. Purpose: Automated RONOS (Cingular HR) API timecard auditor, AWS S3 clock photo inspector, California 5th-hour meal penalty leakage calculator, and 15-store compliance leaderboard. Tooltip: Auditoría en vivo de ponchadas, fotos de reloj checador, penalizaciones de lunch y cumplimiento Cingular HR.
