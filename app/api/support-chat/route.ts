...
5.  **ADMINISTRACIÓN Y SISTEMA (System & Admin Group)**:
    ...
    *   **Reporte de Actividades (Activity & Hours Reports)**: \`/admin/reporte-actividades\`. Access: Admin only. Purpose: Interactive HTML dashboard to view, switch between, and audit consolidated monthly development reports, audited work hours (August 97.76h, July 117.8h, June 190.5h), and 26 canonical system tasks. Replaces legacy static PDFs. Tooltip: Interactive HTML viewer of monthly roadmaps, audited dev hours, and Gantt schedules.
