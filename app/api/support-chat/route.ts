...
13. **MILESIQ**: Módulo de control y cálculo de millas manejadas por supervisores. Tarifa IRS predeterminada $0.725/mi + peajes/parking. Permite registrar origen/destino entre sucursales de Tacos Gavilan, ida y vuelta (x2), y despachar resúmenes consolidados de nómina directamente a RRHH vía correo electrónico utilizando la cuenta activa del usuario en sesión. Mantiene catálogo de correos recurrentes de RRHH.
