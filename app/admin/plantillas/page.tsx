...
export default function TemplatesPage() {
    ...
    return (
        <div className="bg-transparent h-screen overflow-hidden font-sans pt-16 md:pt-0">
            ...
            <div className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-20 shrink-0">
                <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href="/admin" className="w-8 h-8 rounded-xl bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-gray-200 transition-colors">
                            <ArrowLeft size={18} />
                        </Link>
                        <div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="w-8 h-8 md:w-auto md:h-auto md:px-4 md:py-1.5 rounded-full bg-red-600 text-white flex items-center justify-center gap-2 hover:bg-red-700 transition-transform active:scale-95 shadow-lg shadow-red-200"
                        >
            ...
            <main className="flex-1 overflow-y-auto h-full max-w-7xl mx-auto px-4 md:px-8 py-8 pb-24 w-full">
