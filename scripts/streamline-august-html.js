...
const daysData = [
  ...
  { date: '03-Ago', dayName: 'Lun / Mon', scheduled: '12:00 PM - 8:00 PM', shiftHours: 8.0, dev: 3.25, mgr: 4.75, modules: 'Inventario, Tech Pack', note: 'QB Estimates y Tech Pack Uniformes' },
  { date: '04-Ago', dayName: 'Mar / Tue', scheduled: '2:00 PM - 10:00 PM', shiftHours: 8.0, dev: 9.00, mgr: 0.00, modules: 'Preparador, Auditoría', note: 'Edición táctil, modo manual semanal y auditoría' },
  ...
  { date: '08-Ago', dayName: 'Sáb / Sat', scheduled: '2:00 PM - 9:00 PM', shiftHours: 7.0, dev: 7.15, mgr: 0.00, modules: 'Preparador, Menú TVs', note: 'Pace de parrilla carnes y pantallas de menú' },
  { date: '09-Ago-2026', dayName: 'Dom / Sun', scheduled: '2:00 PM - 7:00 PM', shiftHours: 5.0, dev: 2.00, mgr: 3.00, modules: 'Preparador', note: 'Simulación intraday y acelerador de parrilla' },
  ...
  { date: '12-Ago', dayName: 'Mié / Wed', scheduled: 'Descanso en Tienda', shiftHours: 0.0, dev: 4.33, mgr: 0.00, modules: 'Basecamp 3 API', note: 'Integración API Basecamp y sincronizador' },
  ...
  { date: '14-Ago', dayName: 'Vie / Fri', scheduled: '2:00 PM - 9:00 PM', shiftHours: 7.0, dev: 0.00, mgr: 7.00, modules: 'Gerencia Operativa', note: 'Supervisión en piso de restaurante Lynwood' },
  ...
  { date: '16-Ago', dayName: 'Dom / Sun', scheduled: '2:00 PM - 7:00 PM', shiftHours: 5.0, dev: 6.00, mgr: 0.00, modules: 'MilesIQ, Planificador', note: 'GPS de tiendas y soporte IA' },
  { date: '17-Ago', dayName: 'Lun / Mon', scheduled: '12:00 PM - 8:00 PM', shiftHours: 8.0, dev: 4.43, mgr: 3.57, modules: 'Radar Precios, QB', note: 'Auditoría laboral y catálogo Viele' },
  ...
  { date: '19-Ago', dayName: 'Mié / Wed', scheduled: '9:00 AM - 5:00 PM', shiftHours: 8.0, dev: 3.50, mgr: 4.50, modules: 'Uniformes, Radar', note: 'Auditoría forense 17 bugs y roles' },
  { date: '20-Ago', dayName: 'Jue / Thu', scheduled: 'Descanso en Tienda', shiftHours: 0.0, dev: 3.05, mgr: 0.00, modules: 'Basecamp, MilesIQ', note: 'Rediseño ejecutivo y coordenadas' },
  { date: '21-Ago-2026', dayName: 'Vie / Fri', scheduled: '2:00 PM - 9:00 PM', shiftHours: 7.0, dev: 2.35, mgr: 4.65, modules: 'Basecamp, Alertas', note: 'Carga bajo demanda, alertas correo y PDF' }
];
...
console.log('✅ pendientes_agosto.html simplificado y limpio!');
