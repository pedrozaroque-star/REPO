  ...
  return `
    <div class="dual-bar-col" data-idx="${idx}">
        <div class="dual-bar-tooltip">
            ...
            <div class="tooltip-row" style="margin-bottom: 4px; font-size: 10.5px; color: #0284c7;">
                <span>🎯 <strong>Modalidad:</strong></span>
                <strong>${modeTag}</strong>
            </div>
            <div class="tooltip-row" style="margin-bottom: 6px; font-size: 10.5px; color: #d97706;">
            ...
            <div class="tooltip-modules">
                📦 <em>${d.modules}</em><br>
                📝 <span style="font-size: 10px; color: #64748b;">${d.note}</span>
            </div>
        </div>
...
<div class="dual-workday-card-light">
    ...
    <!-- Clean Light Themed Stacked Bar Chart Canvas -->
    <div class="chart-container-card-light">
        ...
        <div class="dual-chart-body-light">
            <!-- Y Axis Labels -->
...
<style>
/* ==========================================================================
   CLEAN LIGHT THEME DUAL WORKDAY DISTRIBUTION (CARLOS VELAZQUEZ)
   ========================================================================== */
...
.dual-bar-tooltip {
    ...
    padding: 12px 14px;
    width: 250px;
    box-shadow: 0 15px 30px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(99, 102, 241, 0.2);
    opacity: 0;
    visibility: hidden;
...
@media (max-width: 768px) {
    ...
    .chart-bars-viewport { gap: 4px; overflow-x: auto; }
    .dual-bar-col { min-width: 14px; }
    .dual-bar-tooltip { width: 210px; font-size: 10px; }
}
</style>
`;
...
// Replace dark styles with clean light styles
const styleRegex = /<style>[\s\S]*?DUAL WORKDAY DISTRIBUTION STACKED BAR CHART[\s\S]*?<\/style>/;
...
console.log('✅ pendientes_agosto.html actualizado al tema blanco ejecutivo limpio!');
