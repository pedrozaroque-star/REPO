...
export default function TopNav() {
    ...
    const menuGroups: MenuGroup[] = [
        ...
        },
        {
            ...
            id: 'equipo',
            items: [
                { name: 'ROLES', path: '/roles', icon: <Users size={20} />, roles: ['manager', 'supervisor', 'admin', 'asistente'] },
    ...
    const filteredGroups = useMemo(() => {
        ...
        return menuGroups.map(group => {
            // Si es Vikesh, ocultamos grupos enteros de Inventario y Food Cost
            ...
            <div className="mx-auto flex h-16 max-w-[1600px] items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-2 md:gap-8">
                    <Link href="/dashboard" className="flex items-center gap-2 group relative">
                        ...
                        <div className="flex flex-col leading-tight ml-2 md:ml-12">
