              ...
              >
                ...
                <div className="p-6 text-center relative">
                  ...
                  <p className="text-gray-600 mb-3 text-sm leading-relaxed">
                    Para enviar los <strong>comentarios de inspección</strong> al Manager, inicia sesión con tu correo corporativo de <strong>Tacos Gavilán</strong>.
                  </p>

                  <div className="bg-gray-50 rounded-xl p-3 mb-3 text-left border border-gray-200">
                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Tu cuenta corporativa es:</p>
                    ...
                    <p className="text-[10px] text-gray-400 mt-1.5 italic">Ej: carlos@tacosgavilan.com, maria@tacosgavilan.com</p>
                  </div>
                  ...
                  <div className="bg-green-50 rounded-xl p-3 mb-3 text-left flex gap-2 border border-green-200">
                    ...
                    <div className="text-xs text-green-800">
                      <span className="font-bold">Tu inspección está segura.</span> Se guardará automáticamente y al volver se restaurará exactamente como la dejaste.
                    </div>
                  </div>
                  ...
                  <div className="bg-blue-50 rounded-xl p-3 mb-4 text-left flex gap-2 border border-blue-200">
                    ...
                    <div className="text-xs text-blue-800">
                      El Manager recibirá tus observaciones desde <b>TU</b> correo. Usa tu cuenta <b>@tacosgavilan.com</b>, NO tu Gmail personal.
                    </div>
                  </div>
