            ...
            >
              ...
              >
                ...
                <div className="p-8 text-center relative">
                  ...
                  <div className="w-20 h-20 bg-white rounded-full shadow-lg mx-auto flex items-center justify-center mb-6 relative z-10 -mt-2 border-2 border-gray-100">
                  ...
                  <h2 className="text-2xl font-black text-gray-900 mb-3">
                    📝 Conexión de Gmail Requerida
                  </h2>

                  <p className="text-gray-600 mb-4 text-sm leading-relaxed">
                    Para enviar los <strong>comentarios de inspección</strong> al Manager de la tienda, necesitas iniciar sesión con tu cuenta de correo corporativa de <strong>Tacos Gavilán</strong>.
                  </p>

                  <div className="bg-gray-50 rounded-xl p-4 mb-4 text-left border border-gray-200">
                    <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Tu cuenta corporativa es:</p>
                    <div className="flex items-center gap-2 bg-white rounded-lg px-4 py-3 border border-gray-100 shadow-sm">
                      <span className="text-lg">📧</span>
                      <span className="text-sm font-black text-gray-800">tunombre<span className="text-blue-600">@tacosgavilan.com</span></span>
                    </div>
                    <p className="text-[11px] text-gray-400 mt-2 italic">Ejemplo: carlos@tacosgavilan.com, maria@tacosgavilan.com</p>
                  </div>

                  <div className="bg-amber-50 rounded-xl p-4 mb-4 text-left flex gap-3 border border-amber-200">
                    <span className="text-amber-500 shrink-0 mt-0.5 text-lg">⚠️</span>
                    <div className="text-xs text-amber-800">
                      <span className="font-bold block mb-1">¿Qué sucederá?</span>
                      Se abrirá la página de inicio de sesión de Google. Selecciona tu cuenta <b>@tacosgavilan.com</b> (NO tu Gmail personal). <strong>Tu inspección en progreso se guardará automáticamente</strong> y al volver se restaurará exactamente como la dejaste.
                    </div>
                  </div>

                  <div className="bg-blue-50 rounded-xl p-4 mb-6 text-left flex gap-3 border border-blue-200">
                    <ShieldCheck className="text-blue-600 shrink-0 mt-0.5" size={20} />
                    <div className="text-xs text-blue-800">
                      <span className="font-bold block mb-1">¿Por qué es obligatorio?</span>
                      El Manager recibirá tus observaciones directamente desde <b>TU</b> correo corporativo. Esto genera confianza y evita que los correos terminen en SPAM.
                    </div>
                  </div>

                  <button
                    onClick={saveDraftAndRedirect}
                    className="w-full bg-white border-2 border-gray-200 text-gray-700 py-3.5 px-4 rounded-xl font-bold hover:bg-gray-50 hover:shadow-lg hover:border-blue-300 transition-all flex items-center justify-center gap-3 group"
                  >
