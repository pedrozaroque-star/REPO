            ...
            <div className="flex items-center gap-2 bg-white/60 dark:bg-slate-800/60 rounded-2xl p-1.5 shadow-inner border border-slate-200/50 dark:border-slate-700/50 w-fit">
              ...
              {[
                ...
                <button
                  ...
                  className={`px-3 sm:px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-300 flex items-center gap-1.5 ${
                  ...
                  {shiftProcedures.map((proc, idx) => {
                    ...
                    return (
                      <Reorder.Item
                        ...
                        className="relative"
                      >
                        <div className={`absolute -left-[21px] sm:-left-[53px] w-4 h-4 rounded-full border-4 border-white dark:border-[#0B1120] bg-gradient-to-br ${isSpecialDay ? 'from-purple-500 to-fuchsia-500 ring-2 ring-purple-300/50 dark:ring-purple-500/30' : shiftColors[proc.shift_type]} shadow-sm z-10 top-6`} />
