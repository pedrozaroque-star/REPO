...
export const MONTHLY_REPORTS: Record<'septiembre' | 'agosto' | 'julio' | 'junio', MonthlyReportData> = {
    ...
    "rows": [
        ...
        {
            "date": "07-Sep-2026",
            "time": "9:47 AM - 12:45 PM & 1:15 PM - 1:45 PM & 3:30 PM - 4:45 PM",
            "hours": 4.75,
            "badges": [
