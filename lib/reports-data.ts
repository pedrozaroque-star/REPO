...
export const MONTHLY_REPORTS: Record<'septiembre' | 'agosto' | 'julio' | 'junio', MonthlyReportData> = {
    ...
    "rows": [
        ...
        {
            "date": "17-Sep-2026",
            "time": "1:15 AM - 1:35 AM & 9:25 AM - 1:45 PM & 1:50 PM - 4:10 PM",
            "hours": 6.9,
            "badges": [
    ...
    "effortSummary": [
        ...
        {
            "module": "Motor de Proyecciones de Ventas (Forecast V3.1) & Event Intelligence",
            "hours": 6.9
        },
        {
        ...
        {
            "module": "Soporte IA Conversacional, Changelog Modal & Versionado UI (v2.10.3)",
            "hours": 3.25
        },
        {
