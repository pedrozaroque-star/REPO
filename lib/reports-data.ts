...
export const MONTHLY_REPORTS: Record<'septiembre' | 'agosto' | 'julio' | 'junio', MonthlyReportData> = {
    ...
    "rows": [
        ...
        {
            "date": "17-Sep-2026",
            "time": "1:15 AM - 1:35 AM & 9:25 AM - 1:45 PM",
            "hours": 4.7,
            "badges": [
    ...
    "effortSummary": [
        ...
        {
            "module": "Soporte IA Conversacional, Changelog Modal & Versionado UI (v2.10.2)",
            "hours": 3.25
        },
        {
