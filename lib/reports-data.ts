...
export const MONTHLY_REPORTS: Record<'septiembre' | 'agosto' | 'julio' | 'junio', MonthlyReportData> = {
    ...
    "rows": [
        ...
        {
            "date": "06-Sep-2026",
            "time": "10:15 AM - 1:45 PM & 3:30 PM - 7:15 PM & 7:45 PM - 9:30 PM & 9:45 PM - 11:30 PM",
            "hours": 10.75,
            "badges": [
                "Viele & Sons v1",
                "Ingeniería Inversa",
