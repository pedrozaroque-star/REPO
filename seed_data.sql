-- MIGRACIÓN MANUAL DE DATOS (AUDITADA Y CORREGIDA AL 100%)
...
BEGIN
  ...
  VALUES ('checklist_apertura', 'Inspección de Apertura', 'standard', true)
  ...
  --------------------------------------------------------------------------------
  INSERT INTO templates (code, title, type, active)
  VALUES ('checklist_cierre', 'Inspección de Cierre', 'standard', true)
  ON CONFLICT (code) DO UPDATE SET title = EXCLUDED.title
  RETURNING id INTO v_template_id;
  ...
  --------------------------------------------------------------------------------
  -- 3. DAILY (34 Preguntas)
  --------------------------------------------------------------------------------
  INSERT INTO templates (code, title, type, active)
  VALUES ('checklist_daily', 'Daily Checklist', 'standard', true)
  ON CONFLICT (code) DO UPDATE SET title = EXCLUDED.title
  RETURNING id INTO v_template_id;
  ...
  --------------------------------------------------------------------------------
  INSERT INTO templates (code, title, type, active)
  VALUES ('checklist_recorrido', 'Recorrido de Limpieza', 'standard', true)
  ON CONFLICT (code) DO UPDATE SET title = EXCLUDED.title
  RETURNING id INTO v_template_id;
  ...
  --------------------------------------------------------------------------------
  INSERT INTO templates (code, title, type, active)
  VALUES ('checklist_sobrante', 'Producto Sobrante', 'standard', true)
  ON CONFLICT (code) DO UPDATE SET title = EXCLUDED.title
  RETURNING id INTO v_template_id;
  ...
  INSERT INTO template_questions (section_id, text, type, order_index) VALUES 
  (v_section_id, 'Arroz', 'yes_no', 0),
  (v_section_id, 'Frijol', 'yes_no', 1),
  (v_section_id, 'Asada', 'yes_no', 2),
  (v_section_id, 'Pastor', 'yes_no', 3),
  (v_section_id, 'Pollo', 'yes_no', 4),
  (v_section_id, 'Carnitas', 'yes_no', 5),
  (v_section_id, 'Buche', 'yes_no', 6),
  (v_section_id, 'Chorizo', 'yes_no', 7),
  (v_section_id, 'Cabeza', 'yes_no', 8),
  (v_section_id, 'Lengua', 'yes_no', 9),
  (v_section_id, 'Frijoles de olla', 'yes_no', 10);

  --------------------------------------------------------------------------------
  -- 6. TEMPERATURAS (21 Preguntas)
  --------------------------------------------------------------------------------
  INSERT INTO templates (code, title, type, active)
  VALUES ('checklist_temperaturas', 'Control de Temperaturas', 'standard', true)
  ON CONFLICT (code) DO UPDATE SET title = EXCLUDED.title
  RETURNING id INTO v_template_id;
