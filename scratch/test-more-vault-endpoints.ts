...
async function run() {
    try {
        ...
        const endpoints = [
            `https://3.basecampapi.com/5052386/buckets/${projectId}/vaults/${vaultId}/attachments.json`,
            `https://3.basecampapi.com/5052386/vaults/${vaultId}/attachments.json`,
            ...
            `https://3.basecampapi.com/5052386/buckets/${projectId}/vaults/${vaultId}/cloud_file.json`,
            `https://3.basecampapi.com/5052386/vaults/${vaultId}/cloud_file.json`,
            `https://3.basecampapi.com/5052386/buckets/${projectId}/vaults/${vaultId}/google_document.json`,
            `https://3.basecampapi.com/5052386/vaults/${vaultId}/google_document.json`,
        ]
